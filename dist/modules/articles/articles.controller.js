...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Create an article' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.CREATED,
        description: 'Article successfully created.',
        type: article_dto_1.ArticleDto,
    }),
    (0, swagger_1.ApiResponse)({
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'List Articles' }),
    (0, swagger_1.ApiResponse)({
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ArticlesController.prototype, "deleteById", null);
