...
exports.steroidReviewsAggregation = void 0;
const mongoose_1 = require("mongoose");
const steroidReviewsAggregation = (steroidId) => {
    const sourceObjectId = steroidId ? new mongoose_1.Types.ObjectId(steroidId) : undefined;
    const populationAggregation = [
        {
            $lookup: {
                from: 'manufacturers',
...
exports.steroidReviewsAggregation = steroidReviewsAggregation;
//# sourceMappingURL=steroids.aggregations.js.map